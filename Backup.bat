...
.\fh_loader.exe --port=\\.\COM%port% --convertprogram2read --sendimage="%backup_folder%\vbmeta_system_a" --start_sector=2774537 --lun=0 --num_sectors=16 --showpercentagecomplete --zlpawarehost=1 --memoryname=ufs
.\fh_loader.exe --port=\\.\COM%port% --convertprogram2read --sendimage="%backup_folder%\vbmeta_system_b" --start_sector=2774553 --lun=0 --num_sectors=16 --showpercentagecomplete --zlpawarehost=1 --memoryname=ufs
...
.\fh_loader.exe --port=\\.\COM%port% --convertprogram2read --sendimage="%backup_folder%\modem_a" --start_sector=4614 --lun=4 --num_sectors=76800 --showpercentagecomplete --zlpawarehost=1 --memoryname=ufs
...
.\fh_loader.exe --port=\\.\COM%port% --convertprogram2read --sendimage="%backup_folder%\abl_a" --start_sector=91142 --lun=4 --num_sectors=256 --showpercentagecomplete --zlpawarehost=1 --memoryname=ufs
...
.\fh_loader.exe --port=\\.\COM%port% --convertprogram2read --sendimage="%backup_folder%\vbmeta_a" --start_sector=132538 --lun=4 --num_sectors=16 --showpercentagecomplete --zlpawarehost=1 --memoryname=ufs
...
.\fh_loader.exe --port=\\.\COM%port% --convertprogram2read --sendimage="%backup_folder%\modem_b" --start_sector=270191 --lun=4 --num_sectors=76800 --showpercentagecomplete --zlpawarehost=1 --memoryname=ufs
...
.\fh_loader.exe --port=\\.\COM%port% --convertprogram2read --sendimage="%backup_folder%\abl_b" --start_sector=356719 --lun=4 --num_sectors=256 --showpercentagecomplete --zlpawarehost=1 --memoryname=ufs
...
.\fh_loader.exe --port=\\.\COM%port% --convertprogram2read --sendimage="%backup_folder%\vbmeta_b" --start_sector=398115 --lun=4 --num_sectors=16 --showpercentagecomplete --zlpawarehost=1 --memoryname=ufs
...
.\fh_loader.exe --port=\\.\COM%port% --convertprogram2read --sendimage="%backup_folder%\vendor_boot_b" --start_sector=472728 --lun=4 --num_sectors=24576 --showpercentagecomplete --zlpawarehost=1 --memoryname=ufs
